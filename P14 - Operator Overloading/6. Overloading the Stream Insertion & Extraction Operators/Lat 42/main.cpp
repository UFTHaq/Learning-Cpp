/*
    ...
    so that it displays a Money object on a output stream as follows.
    ...
    You ONLY need to write the overloaded operator function, our automated tester will 
    create the object and test it.

    This overloaded operator should return a reference to a std::ostream object and should 
    be implemented as a non-member friend function.
