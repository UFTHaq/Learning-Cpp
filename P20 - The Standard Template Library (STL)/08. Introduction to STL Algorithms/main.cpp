...
void find_test() {
    ...
    auto loc1 = std::find(players.begin(), players.end(), Person{"Thor", 20});
    if (loc1 != players.end()) {
        std::cout << "Found Fahmi" << std::endl;
    } else {
        std::cout << "Fahmi not found" << std::endl;
    }
}

// Cound the number elements in a container
void count_test() {
    std::cout << "====================" << std::endl;
...
void count_if_test() {
    ...
    // how many we determine how many elements in vec are >= 5?
...
// Replace occurrances of elements in a container
void replace_test() {
    std::cout << "====================" << std::endl;
...
void string_transform_test() {
    ...
    std::cout << "After transform again: " << str1 << std::endl;
}
