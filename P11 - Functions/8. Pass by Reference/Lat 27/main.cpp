/*
    ...
    guest list to an event and then clear the guest list when the event is over.
    ...
    cannot be modified within the print_guest_list function by using the keyword const 
    ...
    string arguments guest_1, guest_2, and guest_3 which have all been provided to you.
        The print_guest_list function should print the guest list in the order of 
    guest_1, guest_2 , guest_3, with each entry being printed on a new line. For testing 
    purposes, please ensure that a newline is printed after guest_3 either through the 
    use of endl; or the newline character "\n". 
...
int main() {
    ...
    string guest_1 {"Ukhem"};
    string guest_2 {"Fahmi"};
    string guest_3 {"Thoriqul"};
