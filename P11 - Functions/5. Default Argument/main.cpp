...
int main() {
    ...
    cost = calc_cost();                     // Will use all default argument values = 100 + 6 + 3.50
    cout << "Cost is: " << cost << endl;    // 109.5
    cout << endl;

    greeting("Ukhem Fahmi", "Dr.", "S.T.");
    greeting("Thoriqul Haq", "Professor", "Ph.D.");
